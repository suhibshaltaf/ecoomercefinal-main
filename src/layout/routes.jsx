...
import Review from "../components/web/review/Review.jsx";
import CancelOrder from "../components/web/order/CancelOrder.jsx";
      ...
      },
{
      ...
      {
        path: "*",
        element: <h1 className="text-center pt-5">AlTrEfE Shop</h1>,
      },
    ],
  },
  {
